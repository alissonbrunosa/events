...
ActiveRecord::Schema.define(version: 20150827154922) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.integer  "presences_count",    default: 0
    t.integer  "user_id"
  ...
  add_index "presences", ["event_id"], name: "index_presences_on_event_id", using: :btree
